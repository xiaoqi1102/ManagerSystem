...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath : "/"                      //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置+ "net/"
        ...
        , catcherPath: "http://192.168.1.107:91/"                  //图片修正地址，同imagePath
        ...
        , imageManagerPath: "http://192.168.1.107:91/"                                    //图片修正地址，同imagePath
        ...
        //'scrawl', 'insertvideo', 'music', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'emotion', 'snapscreen', 'wordimage', 'print', 'preview',  'help', 'drafts'
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|', 'searchreplace' ,
                ...
                'insertimage', 'attachment', 'template', 'background', '|',
